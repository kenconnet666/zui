...
export type PropCarrier<TValue, TTokens, TKeywords, TUnits = unknown, TExtra = never> = ((
  ...
  } & { readonly [K in TKeywords]: void } & { readonly [K in TExtra]: void } & TUnits
...
export type ColorPropCarrier<TValue, TTokens, TKeywords, TExtra = never> = ((
  ...
  } & { readonly [K in TKeywords]: void } & { readonly [K in TExtra]: void }

export type PropFn<TValue> = ((value: TValue) => void) &
  ((factory: (c: PropFn<TValue>) => void) => void) & { readonly [K in GlobalKw]: void } // ← 新增
```
