...
export interface IcxPropMethods<TSelf, T extends ThemeSchema> {
  ...
  accentColor: ColorPropCarrier<
    ...
    ColorTokens<T>,
    'white' | 'black' | 'transparent' | 'currentColor' | GlobalKw,
    never
  >
  /**
   ...
   */
  animationName: PropCarrier<
    TSelf,
    CssValueOf<'animationName'>,
    never,
    'none' | GlobalKw,
    unknown,
    never
   ...
   */
  columnCount: PropCarrier<
    TSelf,
    CssValueOf<'columnCount'>,
    never,
    'auto' | GlobalKw,
    unknown,
    never
   ...
   */
  columnWidth: PropCarrier<
    TSelf,
    CssValueOf<'columnWidth'>,
    never,
    'auto' | GlobalKw,
    LengthUnits<TSelf>,
    never
   ...
   */
  counterReset: PropCarrier<
    TSelf,
    CssValueOf<'counterReset'>,
    never,
    'none' | GlobalKw,
    unknown,
    never
   ...
   */
  direction: PropCarrier<
    TSelf,
    CssValueOf<'direction'>,
    never,
    'ltr' | 'rtl' | GlobalKw,
    unknown,
    never
   ...
   */
  outlineOffset: PropCarrier<
    TSelf,
    CssValueOf<'outlineOffset'>,
    never,
    GlobalKw,
    LengthUnits<TSelf>,
    never
   ...
   */
  perspective: PropCarrier<
    TSelf,
    CssValueOf<'perspective'>,
    never,
    'none' | GlobalKw,
    LengthUnits<TSelf>,
    never
   ...
   */
  strokeDashoffset: PropCarrier<
    TSelf,
    CssValueOf<'strokeDashoffset'>,
    never,
    GlobalKw,
    LengthUnits<TSelf>,
    never
  ...
  textAlign: PropCarrier<
    ...
    never,
    'left' | 'right' | 'center' | 'justify' | 'start' | 'end' | GlobalKw,
    unknown,
    never
  >
  /**
  ...
  textDecorationLine: PropCarrier<
    ...
    never,
    'none' | 'underline' | 'overline' | 'lineThrough' | GlobalKw,
    unknown,
    never
  >
  /**
   ...
   */
  textIndent: PropCarrier<
    TSelf,
    CssValueOf<'textIndent'>,
    SpacingTokens<T>,
    GlobalKw,
    LengthUnits<TSelf>,
    never
  ...
  textTransform: PropCarrier<
    ...
    never,
    'none' | 'capitalize' | 'uppercase' | 'lowercase' | GlobalKw,
    unknown,
    never
  >
  /**
   ...
   */
  translate: PropCarrier<
    TSelf,
    CssValueOf<'translate'>,
    never,
    'none' | GlobalKw,
    LengthUnits<TSelf>,
    never
  ...
  whiteSpace: PropCarrier<
    ...
    never,
    'normal' | 'nowrap' | 'pre' | 'preWrap' | 'preLine' | 'breakSpaces' | GlobalKw,
    unknown,
    never
  >
  /**
  ...
  wordBreak: PropCarrier<
    ...
    never,
    'normal' | 'breakAll' | 'keepAll' | 'breakWord' | GlobalKw,
    unknown,
    never
  >
  /**
