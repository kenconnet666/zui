...
const propsRows = [
  ...
  { name: 'minWidth', type: 'number',               default: '20',   desc: '引导卡片最小宽度（iem 倍数，默认 320px）。' },
  { name: 'maxWidth', type: 'number',               default: '32',   desc: '引导卡片最大宽度（iem 倍数，默认 512px）。' },
...
<template>
  <section>
    ...
    <ZParagraph>
      ...
      <ZCode code="steps" /> 配置步骤列表，<ZCode code="open" /> / <ZCode code="current" /> 控制显示和进度。
    </ZParagraph>
