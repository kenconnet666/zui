...
const propsRows = [
  ...
  { name: 'size', type: 'number', default: '1', desc: 'px 倍数（1 单位 = 16px）。默认 1 = 16px 字号，padding/border-radius 等比缩放（高度由 rows 决定，不受 size 影响）。' },
...
<template>
  <section>
    <ZTitle :level="1">ZTextarea 多行输入</ZTitle>
    <ZParagraph>
