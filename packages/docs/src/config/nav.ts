...
export const docNav: DocNavItem[] = [
...

  {
    ...
    children: [
      ...
      { key: 'checkbox', label: 'ZCheckbox / Group 复选框', route: '/input/checkbox' },
      { key: 'radio', label: 'ZRadio / Group 单选框', route: '/input/radio' },
      ...
      { key: 'form', label: 'ZForm / Item 表单', route: '/input/form' },
