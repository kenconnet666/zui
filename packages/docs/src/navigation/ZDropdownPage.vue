...
const propsRows = [
  ...
  { name: 'placement', type: 'Placement',            default: "'bottom-start'", desc: 'Floating-UI 定位方向。' },
  { name: 'visible',   type: 'boolean',              default: 'false',     desc: '是否可见（v-model:visible，manual 模式用）。' },
