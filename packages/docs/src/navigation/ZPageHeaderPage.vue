...
import BasicDemo from './ZPageHeader/BasicDemo.vue'
...
const emitsRows = [
  { name: 'back', type: '() => void', desc: '点击返回按钮时触发（通常 router.back()）。' },
]
...
<template>
  <section>
    ...
    <DemoBlock title="带返回 / 无返回 / extra 操作区" :source="BasicDemoSource">
      <BasicDemo />
    </DemoBlock>
