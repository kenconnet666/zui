...
<template>
  <section>
    ...
    <ZParagraph>
      ...
      <ZCode code="rel" /> / <ZCode code="disabled" /> 四个链接专属字段。 默认颜色
      <ZCode code="_primary" />，默认 hover 时显示下划线。 <ZCode code='target="_blank"' /> 自动补
      <ZCode code='rel="noopener noreferrer"' />， <ZCode code="disabled" /> 走
      <ZCode code="aria-disabled" /> + 屏蔽 href。
    </ZParagraph>

    <ZTitle :level="2">基础用法</ZTitle>
    <DemoBlock title="href / target / color / disabled" :source="BasicDemoSource">
      <template #desc>
        不传 <ZCode code="href" /> 退化为普通行内文本（适合 SPA router-link 场景，用
        <ZCode code="tag" /> 换成 RouterLink）。
      </template>
      <BasicDemo />
    </DemoBlock>
    ...
    <DemoBlock title="underline / 外链 / 颜色 / 禁用" :source="StateDemoSource">
      <template #desc>
        ...
        <ZCode code="target='_blank'" /> 自动补 <ZCode code="rel" />;<ZCode code="disabled" />
        屏蔽点击。
      </template>
      <StateDemo />
    </DemoBlock>
      ...
      :rows="[
        {
          ...
          type: 'string',
          default: '—',
          desc: '跳转地址，disabled=true 时自动屏蔽。',
        },
        {
          name: 'target',
          type: 'string',
          default: '—',
          desc: `'_blank' 自动补 rel=noopener noreferrer。`,
        },
        { name: 'rel', type: 'string', default: '—', desc: '显式传则接管自动补的 rel。' },
        {
          ...
          type: 'boolean',
          default: 'false',
          desc: '禁用：屏蔽 href + opacity._dim + pointer-events:none + aria-disabled。',
        },
        {
          name: 'color',
          type: '(c: ColorCarrier) => void',
          default: '_primary',
          desc: '颜色 factory，覆盖默认 _primary。',
        },
        {
          name: 'underlineOnHover',
          type: 'boolean',
          default: 'true',
          desc: 'hover 时下划线（链接惯例），与 ZText 默认值不同。',
        },
        {
          name: 'tag',
          type: 'string',
          default: `'a'`,
          desc: '根元素 tag，SPA 场景可传 RouterLink 组件。',
        },
        {
          name: '...ZText',
          type: '(继承全部 ZText props)',
          default: '—',
          desc: 'size / weight / depth / leading / tracking / italic / underline / strikethrough / mono / ellipsis / css。',
        },
      ]"
    />
