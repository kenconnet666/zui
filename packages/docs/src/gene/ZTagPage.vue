...
<template>
  <section>
    ...
    <DemoBlock title="closable + round + size" :source="ClosableDemoSource">
      <template #desc>
        <ZCode code="closable" /> 显示关闭按钮并 emit <ZCode code="close" />;<ZCode code="round" />
        全圆角。
      </template>
      <ClosableDemo />
    </DemoBlock>
    ...
    <ApiTable
      ...
      :rows="[
        ...
        },
        {
          ...
          desc: '主色 factory，影响文字色 / 边框 / 背景（根据 variant 不同）。',
        },
        {
          name: 'size',
          type: 'number',
        ...
        },
        {
          ...
          type: 'boolean',
          default: 'false',
          desc: '显示关闭按钮，点击触发 close 事件。',
        },
        {
          name: 'round',
          type: 'boolean',
          default: 'false',
          desc: '圆角胶囊形（borderRadius: _full）。',
        },
      ...
      :rows="[
        {
          ...
          desc: '点击关闭按钮时触发（需 closable=true）。',
        },
      ]"
    />
  </section>
