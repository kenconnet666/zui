...
import { ZCarousel, ZFlex, ZText } from '@kenconnet666/zui-vue'
import { ref } from 'vue'

const slides = [
  { label: '幻灯片 1', color: '#4f8ef7' },
  { label: '幻灯片 2', color: '#67c23a' },
  { label: '幻灯片 3', color: '#e6a23c' },
  { label: '幻灯片 4', color: '#f56c6c' },
]
const current = ref(0)
</script>
